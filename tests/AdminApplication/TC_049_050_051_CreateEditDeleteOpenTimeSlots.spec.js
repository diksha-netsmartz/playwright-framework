 ...
 **/
test('TC_049_050_051: C-Admin >> Scheduling >> Manage time slot >> Open time slot - To verify user able to Create, Edit and Delete open time slot', { tag: ['@CAdmin', '@scheduling'] }, async ({ page }) => {
