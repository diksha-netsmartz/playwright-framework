 ...
 **/
test('TC_009: C-admin > Scheduling > Manage Appointment Slot > Appointment Bulk Edit - Verify user is able to Edit, Delete, Cancel and Shift Appointment', { tag: ['@scheduling', '@smoke'] }, async ({page}) => {
