...
/**
 * TC0106: C-Admin >> Multi Instructor
 ...
 **/
test("TC0106: C-Admin >> Multi Instructor - To Verify staff is able to copy/paste appointment", { tag: ['@CAdmin', '@scheduling'] }, async ({ page }) => {
