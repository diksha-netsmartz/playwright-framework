...
/**
 * Page Object representing the Written Test (WT / Knowledge Test) Online Enrollment Page.
 * Handles package selection, student registration form, address autocomplete, DOB, payment, and SMS opt-in.
 */
export default class WTOnlineEnrollmentPage extends BasePage {
    /**
     * Initializes locators and state for the Written Test Online Enrollment Page.
    ...
    **/
    ...
    /**
     * Navigates to the Written Test (Knowledge Test) Online Enrollment page using the configured KT URL.
    **/
    async navigateToWTOEPage() {
        await test.step('Navigate to Written Test Online Enrollment Page', async () => {
    ...
    **/
    async fillStudentInfo() {
        await test.step('Fill Written Test Student Registration Form', async () => {
            this.uniqueId = `${Date.now()}_${Math.floor(100000 + Math.random() * 900000)}`;
            ...
            await this.fill(this.emailTxt, `wt_${this.uniqueId}@gmail.com`);
